...
function readfile()
{       
	NUM_CHAPTERS=$(( `ls ../chapters/[0-9]*.txt | wc -l ` ))
	...
	touch ../chapters/out.txt
        python ../browser/create.py $CURRENT_CHAPTER ../chapters $(($size-10))
        echo "$CURRENT_CHAPTER">../chapters/chapter.txt
...
function next()
{
        CURRENT_CHAPTER=`cat ../chapters/chapter.txt`
